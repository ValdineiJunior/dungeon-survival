  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-screen overflow-hidden pb-28">
        {/* Header */}
        <header className="shrink-0 flex items-center justify-center p-1 md:p-4 border-b border-amber-500/30 bg-slate-900/60">
        ...
        {/* Conteúdo por view */}
        {view === "main" && (
          <main className="flex-1 flex flex-col p-1 md:p-4 lg:p-6 max-w-4xl mx-auto w-full min-h-0 overflow-auto pb-28">
        ...
        {view === "historia" && (
          <main className="flex-1 flex flex-col p-1 md:p-4 lg:p-6 max-w-4xl mx-auto w-full min-h-0 overflow-hidden">
            <section className="flex-1 min-h-0 flex flex-col rounded-md md:rounded-xl border border-amber-500/40 bg-slate-900/90 shadow-2xl overflow-hidden">
              <div className="p-1 md:p-4 lg:p-6 overflow-y-auto flex-1 text-slate-200 pb-24">
        ...
        {view === "comoJogar" && (
          <main className="flex-1 flex flex-col p-1 md:p-4 lg:p-6 max-w-4xl mx-auto w-full min-h-0 overflow-hidden">
            <section className="flex-1 min-h-0 flex flex-col rounded-md md:rounded-xl border border-amber-500/40 bg-slate-900/90 shadow-2xl overflow-hidden">
              <div className="shrink-0 flex items-center gap-3 px-1 py-1 md:px-4 md:pt-4 md:pb-3 border-b border-amber-500/20">
        ...
        {view === "hunter" && (
          <main className="flex-1 flex flex-col items-center justify-center p-1 md:p-6">
            <div className="rounded-md md:rounded-xl border border-amber-500/40 bg-slate-900/90 p-1 md:p-8 max-w-md text-center">
        ...
        <nav className="fixed bottom-0 left-0 right-0 z-20 border-t border-amber-500/30 bg-slate-900/95 backdrop-blur-sm p-1 md:p-3 lg:p-4">
          <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 md:gap-3">
            <button
              type="button"
              onClick={() => setView("historia")}
              className={`flex flex-col items-center gap-1 md:gap-2 p-1 md:p-3 lg:p-4 rounded-md md:rounded-xl border-2 transition-all hover:scale-[1.02] ${
                view === "historia"
            ...
            <Link
              href="/game"
              className="flex flex-col items-center justify-center gap-1 md:gap-2 p-1 md:p-3 lg:p-4 rounded-md md:rounded-xl border-2 border-amber-500 bg-amber-600/30 hover:bg-amber-500/40 hover:border-amber-400 transition-all hover:scale-[1.02] col-span-2 lg:col-span-1"
            >
              <span className="text-2xl md:text-3xl">🚪</span>
