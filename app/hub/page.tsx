...
type HubView = "main" | "historia" | "hunter" | "loja";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-screen overflow-hidden pb-28">
        {/* Header */}
        <header className="shrink-0 flex items-center justify-center p-4 border-b border-amber-500/30 bg-slate-900/60">
        ...
        {view === "historia" && (
          <main className="flex-1 flex flex-col p-4 md:p-6 max-w-4xl mx-auto w-full min-h-0 overflow-hidden">
            <section className="flex-1 min-h-0 flex flex-col rounded-xl border border-amber-500/40 bg-slate-900/90 shadow-2xl overflow-hidden">
              <div className="p-4 md:p-6 overflow-y-auto flex-1 text-slate-200 pb-24">
        ...
        {view === "hunter" && (
          <main className="flex-1 flex flex-col items-center justify-center p-6">
            <div className="rounded-xl border border-amber-500/40 bg-slate-900/90 p-8 max-w-md text-center">
        ...
        {/* Navegação fixa na parte de baixo - 4 botões (sempre visível) */}
        <nav className="fixed bottom-0 left-0 right-0 z-20 border-t border-amber-500/30 bg-slate-900/95 backdrop-blur-sm p-4">
          <div className="max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            <button
              onClick={() => setView("historia")}
              className={`flex flex-col items-center gap-1 md:gap-2 p-4 md:p-5 rounded-xl border-2 transition-all hover:scale-[1.02] ${
                view === "historia"
            ...
            >
              ...
              <span className="font-bold text-amber-400 text-sm md:text-base">História</span>
            </button>
            <button
            ...
            >
              <span className="text-3xl md:text-4xl">🎯</span>
              <span className="font-bold text-amber-400 text-sm md:text-base">Hunter</span>
            </button>
            <button
            ...
            >
              ...
              <span className="font-bold text-amber-400 text-sm md:text-base">Loja de Armas</span>
            </button>
            <Link
              href="/game"
              className="flex flex-col items-center gap-1 md:gap-2 p-4 md:p-5 rounded-xl border-2 border-amber-500 bg-amber-600/30 hover:bg-amber-500/40 hover:border-amber-400 transition-all hover:scale-[1.02]"
            >
              <span className="text-3xl md:text-4xl">🚪</span>
              <span className="font-bold text-amber-300 text-sm md:text-base">Iniciar Aventura</span>
            </Link>
          </div>
        </nav>
      </div>
