...
export function Hand({ cards, energy, selectedCard, onSelectCard, onEndTurn, canEndTurn, disabled }: HandProps) {
  return (
    <div className="flex items-center gap-4 p-4 min-h-[200px]">
      {/* Cards */}
