        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <section>
            ...
            <p className="text-slate-300 text-sm">
              Sobreviva aos 4 andares da masmorra derrotando todos os inimigos
              em cada sala. Use suas cartas estrategicamente para atacar,
              defender e se movimentar pelo mapa hexagonal.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-300 text-sm mb-2">
              No início de cada rodada, a ordem de turno é definida pela
              iniciativa: todos rolam dados. Quem tiver o maior total age
              primeiro. Você escolhe quais dos seus dados rolar (pode rolar 1 ou
              os 2).
            </p>
          ...
          <section>
            ...
            <ul className="text-slate-300 text-sm space-y-1 list-disc list-inside">
              ...
              <li>
                Os cards dos inimigos mostram a intenção (ataque, defesa,
                movimento) da rodada
              </li>
              <li>
                Use o botão &quot;📜 Log&quot; para ver o histórico de ações
              </li>
            </ul>
          </section>
        </div>
