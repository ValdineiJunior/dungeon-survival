    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-2 mb-2">
          {([4, 6, 8, 10, 12, 20] as const).map((faces) => (
            <span
              key={faces}
              className="inline-flex items-center gap-1.5 bg-slate-700/60 text-slate-300 text-xs px-2 py-1 rounded-lg"
            >
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          <div className="flex items-center gap-2 bg-blue-900/30 rounded-lg px-2 py-1.5 border border-blue-800">
            <span className="text-blue-500">⬡</span>
            <span className="text-slate-300">Você</span>
          </div>
          <div className="flex items-center gap-2 bg-red-900/30 rounded-lg px-2 py-1.5 border border-red-800">
            <span className="text-red-500">⬡</span>
            <span className="text-slate-300">Inimigo</span>
          </div>
          <div className="flex items-center gap-2 bg-green-900/30 rounded-lg px-2 py-1.5 border border-green-800">
            <span className="text-green-500">⬡</span>
            <span className="text-slate-300">Movimento válido</span>
          </div>
          <div className="flex items-center gap-2 bg-orange-900/30 rounded-lg px-2 py-1.5 border border-orange-800">
