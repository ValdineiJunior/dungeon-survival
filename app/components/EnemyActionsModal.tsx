    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/80 backdrop-blur-sm z-50">
      <div className="bg-slate-800 rounded-2xl border-2 border-red-800 shadow-2xl max-w-3xl w-full mx-4 max-h-[85vh] flex flex-col pt-2 relative">
        ...
        <div className="flex items-center gap-4 p-4 border-b border-red-800 bg-red-950/30">
          {/* Square Enemy Avatar */}
          <div className="shrink-0 w-24 h-24 relative rounded-xl border-2 border-red-900 bg-slate-900 overflow-hidden shadow-lg">
        ...
        <div className="p-3 border-t border-red-800 text-center">
          <button
            onClick={onClose}
            className="px-4 py-2 md:px-6 md:py-2 bg-red-900 hover:bg-red-800 text-white rounded-lg transition-colors"
          >
            Fechar
          </button>
        </div>
